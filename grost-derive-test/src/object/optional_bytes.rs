...
struct OptionalBytes {
  ...
  #[grost(tag = 4, optional(bytes), wire_format = "Optional<LengthDelimited>")]
  #[cfg(feature = "smallvec_1")]
  smallvec_bytes: Option<smallvec_1::SmallVec<[u8; 24]>>,

  #[grost(tag = 5, optional(bytes), wire_format = "Optional<LengthDelimited>")]
  #[cfg(all(feature = "tinyvec_1", any(feature = "std", feature = "alloc")))]
  tinyvec_bytes: Option<tinyvec_1::TinyVec<[u8; 24]>>,

  #[grost(tag = 6, optional(bytes), wire_format = "Optional<LengthDelimited>")]
  #[cfg(feature = "tinyvec_1")]
  tinyvec_array_bytes: Option<tinyvec_1::ArrayVec<[u8; 24]>>,

  #[grost(tag = 7, optional(bytes), wire_format = "Optional<LengthDelimited>")]
