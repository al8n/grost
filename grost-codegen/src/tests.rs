...
fn test_struct_generate() {
  ...
  let struct_ = Struct::new(SafeIdent::new("User"))
    ...
    .with_fields(vec![
      Field::new(SafeIdent::new("name"), Ty::new(parse_quote!(String)), Tag::new(1)),
      Field::new(SafeIdent::new("age"), Ty::new(parse_quote!(u32)).with_copy().with_wire_ty(Some(WireType::Varint)), Tag::new(2)),
      Field::new(SafeIdent::new("email"), Ty::new(parse_quote!(Option<String>)).with_wire_ty(Some(WireType::LengthDelimited)), Tag::new(3))
