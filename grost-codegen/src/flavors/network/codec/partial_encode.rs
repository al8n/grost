...
impl Network {
  ...
  fn generate_partial_struct_partial_encode_impl(
    ...
    quote! {
      ...
      impl<__GROST_BYTES_BUFFER__, __GROST_UNKNOWN_BUFFER__> #path_to_grost::__private::PartialEncode<#path_to_grost::__private::flavors::network::Network, #path_to_grost::__private::flavors::network::LengthDelimited> for #partial_struct_name<__GROST_BYTES_BUFFER__, __GROST_UNKNOWN_BUFFER__>
      where
