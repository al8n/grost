...
impl Network {
  ...
  fn generate_partial_struct_ref_encode_impl(
    ...
    quote! {
      #[automatically_derived]
      #[allow(non_camel_case_types)]
      impl<'__grost_flavor__> #path_to_grost::__private::Encode<#path_to_grost::__private::flavors::Network, #path_to_grost::__private::flavors::network::LengthDelimited> for #partial_struct_name<'__grost_flavor__> {
        fn encode(
          &self,
          ctx: &<#path_to_grost::__private::flavors::Network as #path_to_grost::__private::flavors::Flavor>::Context,
          buf: &mut [::core::primitive::u8],
