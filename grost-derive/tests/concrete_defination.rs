        ...
        > {
            ...
            if let ::core::option::Option::Some(value) = input.id {
                if selector.is_id_selected() {
                    this
                        .id = <<I as ::grost::__private::convert::State<
                        ::grost::__private::convert::Partial<
                            ::grost::__private::flavors::Groto,
                        >,
            ...
            if let ::core::option::Option::Some(value) = input.name {
                if selector.is_name_selected() {
                    this
                        .name = <<String as ::grost::__private::convert::State<
                        ::grost::__private::convert::Partial<
                            ::grost::__private::flavors::Groto,
                        >,
                    >>::Output as ::grost::__private::convert::PartialTransform<
            ...
            if let ::core::option::Option::Some(value) = input.age {
                if selector.is_age_selected() {
                    this
                        .age = <<u8 as ::grost::__private::convert::State<
                        ::grost::__private::convert::Partial<
                            ::grost::__private::flavors::Groto,
                        >,
                    >>::Output as ::grost::__private::convert::PartialTransform<
            ...
            while offset < buf_len {
                ...
                match &identifier {
                    ...
                    >>::REFLECTION => {
                        ...
                        let (read, value) = (<String as ::grost::__private::decode::Decode<
                            '__grost_decode_lifetime__,
                            ::grost::__private::flavors::Groto,
                            <String as ::grost::__private::flavors::DefaultWireFormat<
                                ::grost::__private::flavors::Groto,
                    ...
                    >>::REFLECTION => {
                        ...
                        let (read, value) = (<u8 as ::grost::__private::decode::Decode<
                            '__grost_decode_lifetime__,
                            ::grost::__private::flavors::Groto,
                            <u8 as ::grost::__private::flavors::DefaultWireFormat<
                                ::grost::__private::flavors::Groto,
