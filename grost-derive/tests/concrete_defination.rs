...
const _: () = {
  ...
  impl<I: Default> PartialUser<I> {
    ...
    #[inline]
    fn update_emails(&mut self, value: ::core::option::Option<Vec<String>>) -> &mut Self {
      self.emails = value;
      self
    }
    /// Set the `emails` to the given value
    ...
    pub const fn new() -> Self {
      Self {
        ...
        >>::Selector as ::grost::__private::selection::Selector<
          ::grost::__private::flavors::Network,
        >>::DEFAULT,
        linkin: <<Option<String> as ::grost::__private::selection::Selectable<
          ::grost::__private::flavors::Network,
        >>::Selector as ::grost::__private::selection::Selector<
          ::grost::__private::flavors::Network,
        >>::DEFAULT,
  ...
  where
    I: ::grost::__private::selection::Selectable<::grost::__private::flavors::Network>,
    I: ::grost::__private::decode::PartialTransform<
        ::grost::__private::flavors::Network,
        grost::flavors::network::LengthDelimited,
        I,
      >,
    PartialUser<I>: ::grost::__private::selection::Selectable<
        ::grost::__private::flavors::Network,
    ...
    > {
      ...
      if let ::core::option::Option::Some(value) = input.id {
        if selector.is_id_selected() {
          this.id = <I as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Network,
            grost::flavors::network::LengthDelimited,
            I,
      ...
      if let ::core::option::Option::Some(value) = input.name {
        if selector.is_name_selected() {
          this.name = <String as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Network,
            <String as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
      ...
      if let ::core::option::Option::Some(value) = input.age {
        if selector.is_age_selected() {
          this.age = <u8 as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Network,
            <u8 as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
      ...
      if let ::core::option::Option::Some(value) = input.emails {
        if selector.is_emails_selected() {
          this.emails = <Vec<String> as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Network,
            <Vec<String> as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
  ...
  where
    ...
    <I as ::grost::__private::convert::State<
      ...
      >,
    >>::Output: ::core::marker::Sized,
    I: ::grost::__private::decode::Transform<
        ::grost::__private::flavors::Network,
        grost::flavors::network::LengthDelimited,
        <I as ::grost::__private::convert::State<
          ::grost::__private::convert::Decoded<
      ...
      > + '__grost_lifetime__,
  {
    ...
    > {
      let mut this = Self::new();
      if let ::core::option::Option::Some(value) = input.id {
        this.id = ::core::option::Option::Some(<I as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Network,
          grost::flavors::network::LengthDelimited,
          <I as ::grost::__private::convert::State<
            ::grost::__private::convert::Decoded<
      ...
      if let ::core::option::Option::Some(value) = input.name {
        this.name =
          ::core::option::Option::Some(<String as ::grost::__private::decode::Transform<
            ::grost::__private::flavors::Network,
            <String as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
      ...
      if let ::core::option::Option::Some(value) = input.age {
        this.age = ::core::option::Option::Some(<u8 as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Network,
          <u8 as ::grost::__private::flavors::DefaultWireFormat<
            ::grost::__private::flavors::Network,
          >>::Format,
      ...
      if let ::core::option::Option::Some(value) = input.emails {
        this.emails =
          ::core::option::Option::Some(<Vec<String> as ::grost::__private::decode::Transform<
            ::grost::__private::flavors::Network,
            <Vec<String> as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
      ...
      if let ::core::option::Option::Some(value) = input.linkin {
        this.linkin =
          ::core::option::Option::Some(<<Option<String> as ::grost::__private::convert::State<
            ::grost::__private::convert::Flatten,
