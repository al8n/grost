  ...
  >>::Output: ::core::marker::Sized,
{
  ...
  emails: ::core::option::Option<
    ...
    >>::Output,
  >,
  linkin: <Option<String> as ::grost::__private::convert::State<
    ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
  >>::Output,
}
...
> where
  I: ::grost::__private::convert::State<
      ::grost::__private::convert::PartialRef<
        '__grost_lifetime__,
        ::grost::__private::flavors::Groto,
        grost::flavors::groto::LengthDelimited,
        __GROST_READ_BUFFER__,
        __GROST_UNKNOWN_BUFFER__,
      >,
    >,
  ...
  >>::Output: ::core::marker::Sized,
{
  ...
  linkin: ::core::option::Option<
    <Option<String> as ::grost::__private::convert::State<
      ::grost::__private::convert::PartialRef<
        '__grost_lifetime__,
        ::grost::__private::flavors::Groto,
...
const _: () = {
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default, __GROST_FLATTEN_STATE__: ?::core::marker::Sized>
  ...
  impl<'__grost_lifetime__, I: Default, __GROST_READ_BUFFER__, __GROST_UNKNOWN_BUFFER__>
    ::grost::__private::convert::State<
      ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
    > for PartialUserRef<'__grost_lifetime__, I, __GROST_READ_BUFFER__, __GROST_UNKNOWN_BUFFER__>
  where
    I: ::grost::__private::convert::State<
        ::grost::__private::convert::PartialRef<
          '__grost_lifetime__,
  ...
  {
    type Output =
      PartialUserRef<'__grost_lifetime__, I, __GROST_READ_BUFFER__, __GROST_UNKNOWN_BUFFER__>;
  }
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<'__grost_lifetime__, I: Default, __GROST_READ_BUFFER__, __GROST_UNKNOWN_BUFFER__>
    ...
    >>::Output: ::core::marker::Sized,
  {
    ...
    const fn linkin_mut(
      ...
      &mut <Option<String> as ::grost::__private::convert::State<
        ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
      >>::Output,
    > {
      self.linkin.as_mut()
    ...
    fn set_linkin(
      &mut self,
      value: <Option<String> as ::grost::__private::convert::State<
        ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
      >>::Output,
    ) -> &mut Self {
    ...
    >>::Output: ::core::marker::Sized,
  {
    ...
    /// Update the `age` to the given value or clear the `age`
    #[inline]
    fn update_age(&mut self, value: ::core::option::Option<u8>) -> &mut Self {
      self.age = value;
      self
    }
    /// Set the `age` to the given value
    #[inline]
    fn with_age(mut self, value: u8) -> Self {
      self.age = ::core::option::Option::Some(value);
      self
    }
    /// Clear the value of `age`
    ...
    /// Update the `age` to the given value or clear the `age`
    #[inline]
    fn maybe_age(mut self, value: ::core::option::Option<u8>) -> Self {
      self.age = value;
      self
    }
    /// Returns a reference to the `emails`
  ...
  impl<I: Default> ::grost::__private::reflection::Reflectable<User<I>>
    ...
    >
  {
    type Reflection = grost::flavors::groto::LengthDelimited;
    const REFLECTION: &'static Self::Reflection = &{
      <grost::flavors::groto::LengthDelimited as ::grost::__private::flavors::WireFormat<
        ::grost::__private::flavors::Groto,
      >>::SELF
    };
  }
    ...
    const REFLECTION: &Self::Reflection = &{
      (::grost::__private::flavors::groto::Identifier::new)(
        ...
        >>::Format as ::grost::__private::flavors::WireFormat<
          ::grost::__private::flavors::Groto,
        >>::WIRE_TYPE,
        (::grost::__private::flavors::groto::Tag::new)(2u32),
      )
    };
  }
  #[automatically_derived]
    ...
    >
  {
    type Reflection =
      <::grost::__private::flavors::Groto as ::grost::__private::flavors::Flavor>::Tag;
    const REFLECTION: &Self::Reflection = &{ (::grost::__private::flavors::groto::Tag::new)(2u32) };
  }
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default> ::grost::__private::reflection::Reflectable<User<I>>
    ...
    >
  {
    type Reflection =
      <::grost::__private::flavors::Groto as ::grost::__private::flavors::Flavor>::Tag;
    const REFLECTION: &Self::Reflection = &{ (::grost::__private::flavors::groto::Tag::new)(3u32) };
  }
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default> ::grost::__private::reflection::Reflectable<User<I>>
    ...
    >
  {
    type Reflection =
      <::grost::__private::flavors::Groto as ::grost::__private::flavors::Flavor>::Tag;
    const REFLECTION: &Self::Reflection = &{ (::grost::__private::flavors::groto::Tag::new)(4u32) };
  }
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default> ::grost::__private::reflection::Reflectable<User<I>>
    ...
    const REFLECTION: &Self::Reflection = &{
      (::grost::__private::flavors::groto::Identifier::new)(
        ...
        >>::Format as ::grost::__private::flavors::WireFormat<
          ::grost::__private::flavors::Groto,
        >>::WIRE_TYPE,
        (::grost::__private::flavors::groto::Tag::new)(5u32),
      )
    };
  }
  #[automatically_derived]
    ...
    >
  {
    type Reflection =
      <::grost::__private::flavors::Groto as ::grost::__private::flavors::Flavor>::Tag;
    const REFLECTION: &Self::Reflection = &{ (::grost::__private::flavors::groto::Tag::new)(5u32) };
  }
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default> ::grost::__private::reflection::Reflectable<User<I>>
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<I: Default> ::grost::__private::indexer::Indexable<::grost::__private::flavors::Groto>
    for User<I>
  {
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<I: Default> ::grost::__private::selection::Selectable<::grost::__private::flavors::Groto>
    for User<I>
  where
    I: ::grost::__private::selection::Selectable<::grost::__private::flavors::Groto>,
  {
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<I: Default> ::grost::__private::selection::Selector<::grost::__private::flavors::Groto>
    for UserSelector<I>
  where
    I: ::grost::__private::selection::Selectable<::grost::__private::flavors::Groto>,
  {
    ...
    fn flip(&mut self) -> &mut Self {
      ...
      <<Option<String> as ::grost::__private::selection::Selectable<
        ::grost::__private::flavors::Groto,
      >>::Selector as ::grost::__private::selection::Selector<
        ::grost::__private::flavors::Groto,
    ...
    I: ::grost::__private::selection::Selectable<::grost::__private::flavors::Groto>,
  {
    ...
    pub fn select_linkin(&mut self) -> &mut Self {
      self.linkin = <<Option<String> as ::grost::__private::selection::Selectable<
        ::grost::__private::flavors::Groto,
      >>::Selector as ::grost::__private::selection::Selector<
        ::grost::__private::flavors::Groto,
      >>::DEFAULT;
    ...
    pub fn update_linkin(
      &mut self,
      value: <Option<String> as ::grost::__private::selection::Selectable<
        ::grost::__private::flavors::Groto,
      >>::Selector,
    ) -> &mut Self {
      self.linkin = value;
    ...
    pub fn maybe_linkin(
      mut self,
      val: <Option<String> as ::grost::__private::selection::Selectable<
        ::grost::__private::flavors::Groto,
      >>::Selector,
    ) -> Self {
      self.linkin = val;
    ...
    pub const fn linkin_mut(
      &mut self,
    ) -> &mut <Option<String> as ::grost::__private::selection::Selectable<
      ::grost::__private::flavors::Groto,
    >>::Selector {
      &mut self.linkin
    }
      ...
      >,
  {
    ...
    where
      ...
      __GROST_UNKNOWN_BUFFER__: ::grost::__private::buffer::Buffer<
        ...
        > + '__grost_lifetime__,
    {
      <PartialUser<I> as ::grost::__private::decode::Decode<
        '__grost_lifetime__,
        ::grost::__private::flavors::Groto,
        ::grost::__private::flavors::groto::LengthDelimited,
        PartialUserRef<'__grost_lifetime__, I, __GROST_READ_BUFFER__, __GROST_UNKNOWN_BUFFER__>,
      ...
      >,
  {
    ...
    where
      ...
      __GROST_UNKNOWN_BUFFER__: ::grost::__private::buffer::Buffer<
        ...
        > + '__grost_lifetime__,
    {
      <PartialUser<I> as ::grost::__private::Decode<
        '__grost_lifetime__,
        ::grost::__private::flavors::Groto,
        ::grost::__private::flavors::groto::LengthDelimited,
        PartialUser<I>,
      ...
      >>::decode(context, src)
      .and_then(|(read, input)| {
        <User<I> as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Groto,
          ::grost::__private::flavors::groto::LengthDelimited,
          PartialUser<I>,
        >>::transform(input)
        ...
        id: {
          if let ::core::option::Option::Some(value) = input.id {
            ...
            return ::core::result::Result::Err(::core::convert::Into::into(
              ::grost::__private::error::Error::field_not_found("User", "id"),
            ));
          }
        },
        name: {
          if let ::core::option::Option::Some(value) = input.name {
            ...
            return ::core::result::Result::Err(::core::convert::Into::into(
              ::grost::__private::error::Error::field_not_found("User", "name"),
            ));
          }
        },
        age: {
          if let ::core::option::Option::Some(value) = input.age {
            ...
            return ::core::result::Result::Err(::core::convert::Into::into(
              ::grost::__private::error::Error::field_not_found("User", "age"),
            ));
          }
        },
        emails: {
  ...
  where
    ...
    <I as ::grost::__private::convert::State<
      ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
    >>::Output: ::grost::__private::decode::PartialTransform<
        ::grost::__private::flavors::Groto,
        grost::flavors::groto::LengthDelimited,
        <I as ::grost::__private::convert::State<
          ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
    ...
    I: ::grost::__private::selection::Selectable<::grost::__private::flavors::Groto>,
  {
    fn partial_transform(
      ...
      ::core::option::Option<PartialUser<I>>,
      <::grost::__private::flavors::Groto as ::grost::__private::flavors::Flavor>::Error,
    > {
      let mut this = Self::new();
      if let ::core::option::Option::Some(value) = input.id {
        if selector.is_id_selected() {
          this.id = <<I as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          >>::Output as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Groto,
            grost::flavors::groto::LengthDelimited,
            <I as ::grost::__private::convert::State<
              ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
      ...
      if let ::core::option::Option::Some(value) = input.name {
        if selector.is_name_selected() {
          this.name = <<String as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          >>::Output as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Groto,
            <String as ::grost::__private::flavors::DefaultWireFormat<
            ...
            <String as ::grost::__private::convert::State<
              ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
            >>::Output,
          >>::partial_transform(value, selector.name_ref())?;
        }
      }
      if let ::core::option::Option::Some(value) = input.age {
        if selector.is_age_selected() {
          this.age = <<u8 as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          >>::Output as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Groto,
            <u8 as ::grost::__private::flavors::DefaultWireFormat<
            ...
            <u8 as ::grost::__private::convert::State<
              ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
            >>::Output,
          >>::partial_transform(value, selector.age_ref())?;
        }
      }
      if let ::core::option::Option::Some(value) = input.emails {
        if selector.is_emails_selected() {
          this.emails = <<Vec<String> as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          >>::Output as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Groto,
            <Vec<String> as ::grost::__private::flavors::DefaultWireFormat<
            ...
            <Vec<String> as ::grost::__private::convert::State<
              ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
            >>::Output,
          >>::partial_transform(value, selector.emails_ref())?;
        }
      }
      if let ::core::option::Option::Some(value) = input.linkin {
        if selector.is_linkin_selected() {
          this.linkin = <<<Option<String> as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          ...
          >>::Output as ::grost::__private::decode::PartialTransform<
            ...
            >>::Output as ::grost::__private::convert::State<
              ::grost::__private::convert::Flatten,
            >>::Output,
          >>::partial_transform(value, selector.linkin_ref())?;
        }
      }
  ...
  where
    ...
    <I as ::grost::__private::convert::State<
      ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
    >>::Output: ::grost::__private::decode::Transform<
        ::grost::__private::flavors::Groto,
        grost::flavors::groto::LengthDelimited,
        <I as ::grost::__private::convert::State<
          ::grost::__private::convert::PartialRef<
      ...
      > + '__grost_lifetime__,
  {
    ...
    > {
      let mut this = Self::new();
      if let ::core::option::Option::Some(value) = input.id {
        this.id = ::core::option::Option::Some(<<I as ::grost::__private::convert::State<
          ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
        >>::Output as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Groto,
          grost::flavors::groto::LengthDelimited,
          <I as ::grost::__private::convert::State<
            ::grost::__private::convert::PartialRef<
      ...
      if let ::core::option::Option::Some(value) = input.name {
        this.name = ::core::option::Option::Some(<<String as ::grost::__private::convert::State<
          ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
        >>::Output as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Groto,
          <String as ::grost::__private::flavors::DefaultWireFormat<
      ...
      if let ::core::option::Option::Some(value) = input.age {
        this.age = ::core::option::Option::Some(<<u8 as ::grost::__private::convert::State<
          ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
        >>::Output as ::grost::__private::decode::Transform<
          ::grost::__private::flavors::Groto,
          <u8 as ::grost::__private::flavors::DefaultWireFormat<
      ...
      if let ::core::option::Option::Some(value) = input.emails {
        this.emails =
          ::core::option::Option::Some(<<Vec<String> as ::grost::__private::convert::State<
            ::grost::__private::convert::Partial<::grost::__private::flavors::Groto>,
          >>::Output as ::grost::__private::decode::Transform<
            ::grost::__private::flavors::Groto,
            <Vec<String> as ::grost::__private::flavors::DefaultWireFormat<
