...
const _: () = {
  ...
  impl<I: Default> PartialUser<I> {
    ...
    #[inline]
    fn update_linkin(&mut self, value: ::core::option::Option<Option<String>>) -> &mut Self {
      self.linkin = value;
      self
    }
    /// Set the `linkin` to the given value
    ...
    /// Update the `linkin` to the given value or clear the `linkin`
    #[inline]
    fn maybe_linkin(mut self, value: ::core::option::Option<Option<String>>) -> Self {
      self.linkin = value;
      self
    }
  }
  ...
  {
    fn transform(
      __grost_partial_object_input__: PartialUser<I>,
    ) -> ::core::result::Result<
      User<I>,
      <::grost::__private::flavors::Network as ::grost::__private::flavors::Flavor>::Error,
    > {
      ...
      > + '__grost_lifetime__,
  {
    ...
    > {
      ...
      if let ::core::option::Option::Some(value) = input.linkin {
        this.linkin = ::core::option::Option::Some(
          <Option<String> as ::grost::__private::decode::Transform<
            ::grost::__private::flavors::Network,
            <Option<String> as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
    ...
    > {
      ...
      if let ::core::option::Option::Some(value) = input.linkin {
        if selector.is_linkin_selected() {
          this.linkin = <Option<String> as ::grost::__private::decode::PartialTransform<
            ::grost::__private::flavors::Network,
            <Option<String> as ::grost::__private::flavors::DefaultWireFormat<
              ::grost::__private::flavors::Network,
            >>::Format,
