...
const _: () = {
  ...
  impl UserIndex {
    ...
    #[allow(non_camel_case_types, clippy::type_complexity)]
    #[inline]
    pub const fn reflection<F>(&self) -> &'static ::grost::__private::reflection::ObjectField
    where
      F: ::grost::__private::flavors::Flavor + ?::core::marker::Sized,
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types, clippy::type_complexity)]
  impl<'__grost_lifetime__, __GROST_UNKNOWN_BUFFER__>
    ::grost::__private::selection::Selectable<
      ::grost::__private::flavors::Network,
      ::grost::__private::flavors::network::LengthDelimited,
    >
  ...
  impl<
        ...
        const __GROST_SELECTED__: ::core::primitive::bool,
    > ::core::iter::Iterator
    for UserSelectorIter<'__grost_lifetime__, F, __GROST_SELECTED__>
    where
        ::grost::__private::reflection::WireFormatReflection<
            User,
            F,
            ...
            while let ::core::option::Option::Some(idx) = current_index {
                if __GROST_SELECTED__ {
                    if self.selector.is_selected(idx) {
                        self.index = idx.next();
                        self.yielded += 1;
                        return ::core::option::Option::Some(idx.reflection::<F>());
                    }
