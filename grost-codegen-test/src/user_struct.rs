...
const _: () = {
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__> ::grost::__private::Selectable<__GROST_FLAVOR__> for PartialUser
  where
    __GROST_FLAVOR__: ?::core::marker::Sized,
  {
    type Selector = <User as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector;
  }
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<'a, __GROST_FLAVOR__: ?::core::marker::Sized, const N: ::core::primitive::bool>
    UserSelectorIter<'a, __GROST_FLAVOR__, N>
  {
    #[inline]
    const fn new(
      selector: &'a UserSelector<__GROST_FLAVOR__>,
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> ::core::cmp::Eq for UserSelector<__GROST_FLAVOR__> {}
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> ::grost::__private::Selectable<__GROST_FLAVOR__>
    for User
  {
    type Selector = UserSelector<__GROST_FLAVOR__>;
  }
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> ::grost::__private::Selector<__GROST_FLAVOR__>
    for UserSelector<__GROST_FLAVOR__>
  {
  ...
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> UserSelector<__GROST_FLAVOR__> {
    ...
    #[inline]
    pub const fn iter_selected(&self) -> UserSelectorIter<__GROST_FLAVOR__, true> {
      UserSelectorIter::new(self, self.selected())
    }
    /// Returns an iterator over the unselected fields.
    #[inline]
    pub const fn iter_unselected(&self) -> UserSelectorIter<__GROST_FLAVOR__, false> {
  ...
  const _: () = {
    ...
    #[allow(non_camel_case_types)]
    impl
      ::grost::__private::Referenceable<
        ::grost::__private::flavors::Network,
        ::grost::__private::flavors::network::LengthDelimited,
      > for User
    {
      type Ref<'__grost_flavor__>
        = PartialUserRef<'__grost_flavor__>
      where
        Self: '__grost_flavor__;
    }
    #[automatically_derived]
    #[allow(non_camel_case_types)]
    impl<'__grost_flavor__> ::core::default::Default for PartialUserRef<'__grost_flavor__> {
      fn default() -> Self {
        Self::new()
      }
    }
          ...
          (*<User>::reflection::<::grost::__private::flavors::Network>()
            ...
            + <<::std::string::String as ::grost::__private::Referenceable<
              ...
              <::std::string::String as ::grost::__private::DefaultWireFormat<
                ::grost::__private::flavors::Network,
              >>::Format,
            >>::Ref<'_> as ::grost::__private::PartialEncode<
              ::grost::__private::flavors::network::Network,
              <::std::string::String as ::grost::__private::DefaultWireFormat<
                ::grost::__private::flavors::Network,
              >>::Format,
          ...
          (*<User>::reflection::<::grost::__private::flavors::Network>()
            ...
            + <<::std::string::String as ::grost::__private::Referenceable<
              ...
              <::std::string::String as ::grost::__private::DefaultWireFormat<
                ::grost::__private::flavors::Network,
              >>::Format,
            >>::Ref<'_> as ::grost::__private::Encode<
              ::grost::__private::flavors::network::Network,
              <::std::string::String as ::grost::__private::DefaultWireFormat<
                ::grost::__private::flavors::Network,
              >>::Format,
    ...
    #[automatically_derived]
    impl
      ::grost::__private::flavors::DefaultWireFormat<::grost::__private::flavors::network::Network>
      for User
    {
    ...
    #[automatically_derived]
    #[allow(non_camel_case_types)]
    impl<'__grost_flavor__, __GROST_FLAVOR__: ?::core::marker::Sized>
      ::grost::__private::Selectable<__GROST_FLAVOR__> for PartialUserRef<'__grost_flavor__>
    {
      type Selector = UserSelector<__GROST_FLAVOR__>;
    }
    #[automatically_derived]
...
pub struct CommentSelector<__GROST_FLAVOR__: ?::core::marker::Sized> {
  ...
  replyer:
    <::core::option::Option<User> as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector,
...
const _: () = {
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__> ::grost::__private::Selectable<__GROST_FLAVOR__> for PartialComment
  where
    __GROST_FLAVOR__: ?::core::marker::Sized,
  {
    type Selector = <Comment as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector;
  }
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  ...
  #[allow(non_camel_case_types)]
  impl<'a, __GROST_FLAVOR__: ?::core::marker::Sized, const N: ::core::primitive::bool>
    CommentSelectorIter<'a, __GROST_FLAVOR__, N>
  {
    #[inline]
    const fn new(
      selector: &'a CommentSelector<__GROST_FLAVOR__>,
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> CommentSelector<__GROST_FLAVOR__> {
    fn debug_helper(
      &self,
      f: &mut ::core::fmt::Formatter<'_>,
    ) -> ::core::result::Result<(), ::core::fmt::Error> {
  ...
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> ::grost::__private::Selectable<__GROST_FLAVOR__>
    for Comment
  {
    type Selector = CommentSelector<__GROST_FLAVOR__>;
  }
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> ::grost::__private::Selector<__GROST_FLAVOR__>
  ...
  impl<__GROST_FLAVOR__: ?::core::marker::Sized> CommentSelector<__GROST_FLAVOR__> {
    ...
    /// Returns an iterator over the selected fields.
    #[inline]
    pub const fn iter_selected(&self) -> CommentSelectorIter<__GROST_FLAVOR__, true> {
      CommentSelectorIter::new(self, self.selected())
    }
    /// Returns an iterator over the unselected fields.
    #[inline]
    pub const fn iter_unselected(&self) -> CommentSelectorIter<__GROST_FLAVOR__, false> {
    ...
    pub fn select_user(
      &mut self,
      val: <User as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector,
    ) -> &mut Self {
      self.user = val;
      self
    }
    ...
    pub const fn user_ref(
      &self,
    ) -> &<User as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector {
      &self.user
    }
    ...
    pub const fn user_mut(
      &mut self,
    ) -> &mut <User as ::grost::__private::Selectable<__GROST_FLAVOR__>>::Selector {
      &mut self.user
    }
  ...
  const _: () = {
    ...
    {
      type Ref<'__grost_flavor__>
        = PartialCommentRef<'__grost_flavor__>
      where
        Self: '__grost_flavor__;
    }
    #[automatically_derived]
    #[allow(non_camel_case_types)]
    impl<'__grost_flavor__> ::core::default::Default for PartialCommentRef<'__grost_flavor__> {
      fn default() -> Self {
        Self::new()
      }
    }
    ...
    impl<'__grost_flavor__> PartialCommentRef<'__grost_flavor__> {
      ...
      pub const fn replyer_ref(
        ...
        &<::core::option::Option<User> as ::grost::__private::Referenceable<
          ::grost::__private::flavors::Network,
      ...
      pub const fn replyer_mut(
        ...
        &mut <::core::option::Option<User> as ::grost::__private::Referenceable<
          ::grost::__private::flavors::Network,
          <::core::option::Option<User> as ::grost::__private::DefaultWireFormat<
            ::grost::__private::flavors::Network,
          >>::Format,
      ...
      pub fn set_replyer(
        &mut self,
        value: <::core::option::Option<User> as ::grost::__private::Referenceable<
          ::grost::__private::flavors::Network,
          <::core::option::Option<User> as ::grost::__private::DefaultWireFormat<
            ::grost::__private::flavors::Network,
          >>::Format,
    ...
    {
      type Reflection =
        fn(&User, &::grost::__private::network::Context) -> ::core::primitive::usize;
      const REFLECTION: &Self::Reflection = &{
        fn encoded_len(
          f: &User,
          ctx: &::grost::__private::flavors::network::Context,
    ...
    #[allow(non_camel_case_types)]
    impl<'__grost_flavor__, __GROST_FLAVOR__: ?::core::marker::Sized>
      ::grost::__private::Selectable<__GROST_FLAVOR__> for PartialCommentRef<'__grost_flavor__>
    {
      type Selector = CommentSelector<__GROST_FLAVOR__>;
    }
    #[automatically_derived]
