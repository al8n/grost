    ...
    > {
        ...
        match f {
            ...
            ::core::option::Option::Some(field) => {
                ...
                buf[offset..offset + identifier_len]
                    .copy_from_slice(
                        &*<User>::reflection().email().encoded_identifier(),
                    );
                offset += identifier_len;
                if offset >= buf_len {
                    return ::core::result::Result::Err(
    ...
    > {
        ...
        const REFLECTION: &Self::Reflection = &{
            ...
            > {
                ...
                buf[offset..offset + identifier_len]
                    .copy_from_slice(
                        &*<Comment>::reflection().user().encoded_identifier(),
                    );
                offset += identifier_len;
                if offset >= buf_len {
                    return ::core::result::Result::Err(
    ...
    > {
        ...
        match f {
            ...
            ::core::option::Option::Some(field) => {
                ...
                buf[offset..offset + identifier_len]
                    .copy_from_slice(
                        &*<Comment>::reflection().replyer().encoded_identifier(),
                    );
                offset += identifier_len;
                if offset >= buf_len {
                    return ::core::result::Result::Err(
    ...
    > {
        ...
        const REFLECTION: &Self::Reflection = &{
            ...
            > {
                ...
                buf[offset..offset + identifier_len]
                    .copy_from_slice(
                        &*<Comment>::reflection().title().encoded_identifier(),
                    );
                offset += identifier_len;
                if offset >= buf_len {
                    return ::core::result::Result::Err(
    ...
    > {
        ...
        match f {
            ...
            ::core::option::Option::Some(field) => {
                ...
                buf[offset..offset + identifier_len]
                    .copy_from_slice(
                        &*<Comment>::reflection().content().encoded_identifier(),
                    );
                offset += identifier_len;
                if offset >= buf_len {
                    return ::core::result::Result::Err(
