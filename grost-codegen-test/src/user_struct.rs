...
pub struct PartialUser<__GROST_BYTES_BUFFER__, __GROST_UNKNOWN_BUFFER__> {
...
const _: () = {
  ...
  impl<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__, __GROST_FLAVOR__>
    ::grost::__private::Selectable<__GROST_FLAVOR__>
    for PartialUser<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__>
  where
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__> ::core::default::Default
    for PartialUser<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__>
  {
    fn default() -> Self {
      Self::new()
  ...
  #[automatically_derived]
  #[allow(non_camel_case_types)]
  impl<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__>
    PartialUser<__GROST_BYTES_BUFFER__, __GROST_UNKNWON_BUFFER__>
  {
  ...
  const _: () = {
    ...
    #[automatically_derived]
    #[allow(non_camel_case_types)]
    impl<__GROST_BYTES_BUFFER__, __GROST_UNKNOWN_BUFFER__>
      ::grost::__private::Encode<
        ::grost::__private::flavors::network::Network,
        ::grost::__private::flavors::network::LengthDelimited,
      > for PartialUser<__GROST_BYTES_BUFFER__, __GROST_UNKNOWN_BUFFER__>
    where
      __GROST_UNKNOWN_BUFFER__: ::grost::__private::Buffer<
          ::grost::__private::flavors::network::Unknown<__GROST_BYTES_BUFFER__>,
        >,
      __GROST_BYTES_BUFFER__: ::grost::__private::BytesBuffer,
    {
      fn encode(
                &self,
                ctx: &<::grost::__private::flavors::network::Network as ::grost::__private::flavors::Flavor>::Context,
        ...
        if !ctx.skip_unknown() {
          if let ::core::option::Option::Some(ref unknowns) = self.__grost_unknown__ {
            ...
            for unknown in unknowns {
              ...
              offset
                                += <::grost::__private::flavors::Network as ::grost::__private::flavors::Flavor>::encode_unknown(
                                    ctx,
                                    unknown,
                                    &mut buf[offset..],
                                )?;
      ...
      fn encoded_len(
        ...
        if !ctx.skip_unknown() {
          if let ::core::option::Option::Some(ref unknowns) = self.__grost_unknown__ {
            ...
            for unknown in unknowns {
              len
                                += <::grost::__private::flavors::Network as ::grost::__private::flavors::Flavor>::encoded_unknown_len(
                                    ctx,
                                    unknown,
                                );
            }
