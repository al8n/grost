...
impl Color {
  ...
  pub const RED_REFLECTION: ::grost::__private::reflection::EnumVariantReflection =
  ...
  pub const GREEN_REFLECTION: ::grost::__private::reflection::EnumVariantReflection =
    ::grost::__private::reflection::EnumVariantReflectionBuilder {
      name: "Green",
      schema_name: "Green",
      description: "",
  ...
  pub const BLUE_REFLECTION: ::grost::__private::reflection::EnumVariantReflection =
    ::grost::__private::reflection::EnumVariantReflectionBuilder {
      name: "Blue",
      schema_name: "Blue",
      description: "",
  ...
  pub const REFLECTION: ::grost::__private::reflection::EnumReflection =
...
impl ::grost::__private::Wirable<::grost::__private::flavors::Network> for Color {
  const WIRE_TYPE: ::grost::__private::flavors::network::WireType =
