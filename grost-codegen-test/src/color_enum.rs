...
const _: () = {
    ...
    impl Color {
        ...
        #[inline]
        pub const fn reflection<__GROST_FLAVOR__>() -> ColorReflection<
            ::grost::__private::reflection::EnumReflection,
            __GROST_FLAVOR__,
        >
        where
    ...
    > {
        type Reflection = ::grost::__private::reflection::EnumReflection;
        const REFLECTION: &Self::Reflection = <Color as ::grost::__private::reflection::Reflectable<
            __GROST_FLAVOR__,
        >>::REFLECTION;
    }
    #[automatically_derived]
    ...
    > {
        ...
        const REFLECTION: &Self::Reflection = &::grost::__private::varing::encode_u32_varint(
            1u32,
        );
    }
    #[automatically_derived]
