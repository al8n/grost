...
impl Color {
    ...
    pub const RED_REFLECTION: ::grost::__private::EnumVariantReflection<
        ::core::primitive::u32,
    ...
    pub const GREEN_REFLECTION: ::grost::__private::EnumVariantReflection<
        ::core::primitive::u32,
    > = ::grost::__private::EnumVariantReflectionBuilder::<::core::primitive::u32> {
        name: "Green",
        schema_name: "Green",
    ...
    pub const BLUE_REFLECTION: ::grost::__private::EnumVariantReflection<
        ::core::primitive::u32,
    > = ::grost::__private::EnumVariantReflectionBuilder::<::core::primitive::u32> {
        name: "Blue",
        schema_name: "Blue",
    ...
    pub const REFLECTION: ::grost::__private::EnumReflection<::core::primitive::u32> = ::grost::__private::EnumReflectionBuilder::<
        ::core::primitive::u32,
    > {
        name: "Color",
        schema_name: "Color",
