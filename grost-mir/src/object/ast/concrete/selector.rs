...
use crate::{
  object::ast::selector::SelectorIterOptions,
  utils::{grost_lifetime, grost_selected_param},
};
...
impl Selector {
  ...
  pub(super) fn from_options(
    ...
    let name = match options.name {
      Some(name) => name,
      None => format_ident!("{}Selector", object_name),
    };
...
// fn derive_selectable_impl<M, F>(object: &super::Object<M, F>) -> proc_macro2::TokenStream {
