...
use crate::meta::flavor::{complex_flavor_ident_error, duplicate_flavor_error};
...
pub(crate) struct FieldFlavorFromMeta {
  pub(crate) flavors: IndexMap<Ident, FieldFlavorValueFromMeta>,
}
