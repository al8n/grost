...
impl<'a, K, KW, S, RB, B> State<PartialRef<'a, Packed<KW>, RB, B, Groto>> for IndexSet<K, S>
where
...
impl<'a, K, KW, S, RB, B> State<Ref<'a, Packed<KW>, RB, B, Groto>> for IndexSet<K, S>
where
  KW: WireFormat<Groto> + 'a,
  Packed<KW>: WireFormat<Groto> + 'a,
  K: State<Ref<'a, KW, RB, B, Groto>>,
...
impl<'a, K, KW, S, RB, B> Decode<'a, Packed<KW>, RB, B, Groto> for IndexSet<K, S>
where
  KW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, S, RB, B> TryFromRef<'a, Packed<KW>, RB, B, Groto> for IndexSet<K, S>
// where
//   KW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, S, RB, B> TryFromPartialRef<'a, Packed<KW>, RB, B, Groto> for IndexSet<K, S>
// where
//   KW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, S, RB, B> PartialTryFromRef<'a, Packed<KW>, RB, B, Groto> for IndexSet<K, S>
// where
//   KW: WireFormat<Groto> + 'a,
