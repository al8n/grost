...
impl<'a, T, N, W, const CAP: usize> Encode<Flatten<Borrowed<'a, Packed<W>>, W>, Groto> for [&N; CAP]
where
  W: WireFormat<Groto>,
...
unsafe impl<T, W, const CAP: usize>
  EquivalentEncode<[&[T]], Flatten<Borrowed<'_, Packed<W>>, W>, Groto> for [T; CAP]
where
  W: WireFormat<Groto>,
...
impl<T, N, W, const CAP: usize> PartialEncode<Flatten<Packed<W>, W>, Groto> for [N; CAP]
where
  W: WireFormat<Groto>,
