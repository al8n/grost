...
impl<'a, K, KW, RB, B, const TAG: u32, const CAP: usize>
  Decode1<'a, Repeated<KW, TAG>, RB, B, Groto> for ArrayVec<K, CAP>
where
...
impl<'a, K, KW, RB, UB, const TAG: u32, const CAP: usize>
  TryFromRef<'a, RB, UB, Repeated<KW, TAG>, Groto> for ArrayVec<K, CAP>
where
  KW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, RB, B, const TAG: u32, const CAP: usize>
  TryFromPartialRef<'a, RB, B, Repeated<KW, TAG>, Groto> for ArrayVec<K, CAP>
where
  KW: WireFormat<Groto> + 'a,
  Repeated<KW, TAG>: WireFormat<Groto> + 'a,
