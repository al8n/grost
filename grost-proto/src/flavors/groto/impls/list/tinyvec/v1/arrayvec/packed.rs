...
impl<'a, K, KW, RB, B, A> Decode1<'a, Packed<KW>, RB, B, Groto> for ArrayVec<A>
where
  A: Array<Item = K>,
...
impl<'a, K, KW, RB, B, A> TryFromRef<'a, RB, B, Packed<KW>, Groto> for ArrayVec<A>
where
  A: Array<Item = K>,
  KW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, RB, B, A> TryFromPartialRef<'a, RB, B, Packed<KW>, Groto> for ArrayVec<A>
where
  A: Array<Item = K>,
  KW: WireFormat<Groto> + 'a,
  Packed<KW>: WireFormat<Groto> + 'a,
