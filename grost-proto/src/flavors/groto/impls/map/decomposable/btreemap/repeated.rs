...
impl<K, V> DefaultRepeatedEntryWireFormat<Groto> for Decomposable<BTreeMap<K, V>> {
...
impl<'a, K, V, KW, VW, RB, B, const TAG: u32>
  State<PartialRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto>> for Decomposable<BTreeMap<K, V>>
where
...
impl<'a, K, KW, V, VW, RB, B, const TAG: u32>
  State<Ref<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto>> for Decomposable<BTreeMap<K, V>>
where
  RepeatedEntry<KW, VW, TAG>: WireFormat<Groto> + 'a,
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, RB, B, const TAG: u32>
  TryFromRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for Decomposable<BTreeMap<K, V>>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, RB, B, const TAG: u32>
  TryFromPartialRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for Decomposable<BTreeMap<K, V>>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, RB, B, const TAG: u32>
  PartialTryFromRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for Decomposable<BTreeMap<K, V>>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
