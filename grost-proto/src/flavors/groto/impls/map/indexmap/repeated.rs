...
use super::{
  super::{MapEntry, repeated_decode, repeated_encode, repeated_encoded_len},
  IndexMap,
};
...
use crate::{
  ...
  flavors::{
    ...
    groto::{
      Context, DecodeError, EncodeError, RepeatedMapDecoder, RepeatedMapDecoderBuffer,
...
impl<'a, K, V, KW, VW, S, RB, B, const TAG: u32>
  State<PartialRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto>> for IndexMap<K, V, S>
where
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  State<Ref<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto>> for IndexMap<K, V, S>
where
  RepeatedEntry<KW, VW, TAG>: WireFormat<Groto> + 'a,
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  Decode<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for IndexMap<K, V, S>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
//   TryFromRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for IndexMap<K, V, S>
// where
//   KW: WireFormat<Groto> + 'a,
//   VW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
//   TryFromPartialRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for IndexMap<K, V, S>
// where
//   KW: WireFormat<Groto> + 'a,
//   VW: WireFormat<Groto> + 'a,
...
// impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
//   PartialTryFromRef<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for IndexMap<K, V, S>
// where
//   KW: WireFormat<Groto> + 'a,
//   VW: WireFormat<Groto> + 'a,
