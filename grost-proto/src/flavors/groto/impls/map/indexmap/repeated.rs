...
use crate::{
  ...
  flavors::{
    groto::{context::RepeatedDecodePolicy, Context, Error, RepeatedMapDecoder, RepeatedMapDecoderBuffer}, DefaultRepeatedEntryWireFormat, Groto, RepeatedEntry, WireFormat
  },
  selection::{Selectable, Selector},
  state::State,
};

impl<K, V, S> DefaultRepeatedEntryWireFormat<Groto> for IndexMap<K, V, S> {
...
impl<'a, K, V, KW, VW, S, RB, B, const TAG: u32>
  State<PartialRef<'a, RB, B, RepeatedEntry<KW, VW, TAG>, Groto>> for IndexMap<K, V, S>
where
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  State<Ref<'a, RB, B, RepeatedEntry<KW, VW, TAG>, Groto>> for IndexMap<K, V, S>
where
  RepeatedEntry<KW, VW, TAG>: WireFormat<Groto> + 'a,
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  Decode1<'a, RepeatedEntry<KW, VW, TAG>, RB, B, Groto> for IndexMap<K, V, S>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  TryFromRef<'a, RB, B, RepeatedEntry<KW, VW, TAG>, Groto> for IndexMap<K, V, S>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  TryFromPartialRef<'a, RB, B, RepeatedEntry<KW, VW, TAG>, Groto> for IndexMap<K, V, S>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
...
impl<'a, K, KW, V, VW, S, RB, B, const TAG: u32>
  PartialTryFromRef<'a, RB, B, RepeatedEntry<KW, VW, TAG>, Groto> for IndexMap<K, V, S>
where
  KW: WireFormat<Groto> + 'a,
  VW: WireFormat<Groto> + 'a,
