...
macro_rules! bytes_bridge {
  ($flavor:ty: $($ty:ty $([ $( const $g:ident: usize), +$(,)? ])?), +$(,)?) => {
    $(
      impl<'a, B, UB, $( $(const $g: usize),* )?> $crate::decode::Decode<'a, $crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited, $crate::__private::decode::BytesSlice<B>, B, UB> for $ty {
        fn decode(context: &'a $crate::__private::flavors::groto::Context, src: B) -> Result<(usize, $crate::__private::decode::BytesSlice<B>), $crate::__private::flavors::groto::Error>
        where
        ...
        {
          <[u8] as $crate::decode::Decode<'a, $crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited, $crate::__private::decode::BytesSlice<B>, B, UB>>::decode(context, src)
        }
      }
    )*
  };
  ...
  (
    ...
    impl<const $g: ::core::primitive::usize> $crate::__private::Encode<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited> for $ty {
      fn encode(
        ...
        <[::core::primitive::u8] as $crate::__private::Encode<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited>>::encode(
          self.as_slice(),
          context,
          buf,
        )
      ...
      fn encode_length_delimited(
        ...
        <[::core::primitive::u8] as $crate::__private::Encode<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited>>::encode_length_delimited(
          self.as_slice(),
          context,
          buf,
        )
      ...
      fn encoded_len(
        ...
        <[::core::primitive::u8] as $crate::__private::Encode<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited>>::encoded_len(
          self.as_slice(),
          context,
        )
      }
      ...
      fn encoded_length_delimited_len(
        ...
        <[::core::primitive::u8] as $crate::__private::Encode<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited>>::encoded_length_delimited_len(
          self.as_slice(),
          context,
        )
      }
    ...
    impl<const $g: ::core::primitive::usize> $crate::__private::selection::Selectable<$crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited> for $ty {
    ...
    impl<'a, UB, $( $(const $g: usize),* )?> $crate::decode::Decode<'a, $crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited, &'a [u8], UB> for $ty {
      ...
      where
        ...
        UB: $crate::buffer::Buffer<$crate::__private::flavors::groto::Unknown<B>> + 'a
      {
        <[u8] as $crate::decode::Decode<'a, $crate::__private::flavors::Groto, $crate::__private::flavors::groto::LengthDelimited, &'a [u8], UB>>::decode(context, src)
      }
    }
