...
/// The decode error for the network flavor.
pub type DecodeError = crate::DecodeError<Network>;
/// The encode error for the network flavor.
pub type EncodeError = crate::EncodeError<Network>;
