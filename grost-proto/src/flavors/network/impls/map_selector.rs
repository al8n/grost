...
where
  K: Selector<Network> + DefaultWireFormat<Network> + PartialEncode<Network, K::Format>,
  V: Selector<Network> + DefaultWireFormat<Network> + PartialEncode<Network, V::Format>,
{
  fn partial_encode(
    &self,
    context: &Context,
