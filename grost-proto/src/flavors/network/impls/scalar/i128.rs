...
selectable_scalar!(Network: i128);
referenceable_scalar!(Network: i128 as Varint, i128 as Fixed128, NonZeroI128 as Varint, NonZeroI128 as Fixed128);
...
selectable_bridge!(Network:i128[NonZeroI128]);
try_from_bridge!(
  Network: i128 {
